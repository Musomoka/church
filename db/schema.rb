...
ActiveRecord::Schema.define(version: 2018_07_06_125053) do
  ...
  create_table "poststatuses", force: :cascade do |t|
    t.string "post_state"
    t.bigint "sermon_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["sermon_id"], name: "index_poststatuses_on_sermon_id"
  end
  ...
  add_foreign_key "poststatuses", "sermons"
